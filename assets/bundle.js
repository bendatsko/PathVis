...
Board.prototype.clearPath = function(clickedButton) {
  ...
  document.getElementById("startButtonStart").onclick = () => {
    if (!this.currentAlgorithm) {
      //maybe put the thing here for when no algorithm is selected
    } else {
...
Board.prototype.changeStartNodeImages = function() {
  ...
  if (unweighted.includes(this.currentAlgorithm)) {
    if (this.currentAlgorithm === "dfs") {
      document.getElementById("algorithmDescriptor").innerHTML = `${name} is unweighted and does not guarantee the shortest path!`;
    } else {
      document.getElementById("algorithmDescriptor").innerHTML = `${name} is unweighted and guarantees the shortest path!`;
    }
    ...
    if (this.currentAlgorithm === "greedy" || this.currentAlgorithm === "CLA") {
      document.getElementById("algorithmDescriptor").innerHTML = `${name} is weighted and does not guarantee the shortest path!`;
    }
...
let varStupid = 1;
Board.prototype.toggleOffExtras = function() {
...
Board.prototype.toggleButtons = function() {
  ...
  if (!this.buttonsOn) {
    ...
    document.getElementById("startButtonStart").onclick = () => {
      if (!this.currentAlgorithm) {
        document.getElementById("startbottom").innerHTML = 'Pick an Algorithm!'
      } else {
        this.clearPath("clickedButton");
        this.toggleButtons();
    ...
    document.getElementById("speedFast").onclick = () => {
      this.speed = "fast";
      document.getElementById("speedBottom").innerHTML = 'Fast';
    }

    document.getElementById("speedModerate").onclick = () => {
      this.speed = "average";
      document.getElementById("speedBottom").innerHTML = 'Moderate';
    }

    document.getElementById("speedSlow").onclick = () => {
      this.speed = "slow";
      document.getElementById("speedBottom").innerHTML = 'Slow';
    }

    document.getElementById("genStair").onclick = () => {
      this.clearWalls();
      this.clearPath("clickedButton");
      this.toggleButtons();
    ...
    document.getElementById("startButtonDijkstra").onclick = () => {
      document.getElementById("startbottom").innerHTML = "Ready to Visualize Dijkstra's!"
      document.getElementById("algobottom").innerHTML = "Dijkstra's Algorithm"
      document.getElementById("algorithmDescriptor").innerHTML = "Dijkstra's Algorithm is weighted and guarantees the shortest path!"
    ...
    document.getElementById("startButtonAStar2").onclick = () => {
      document.getElementById("startbottom").innerHTML = "Ready to Visualize A*!"
      document.getElementById("algorithmDescriptor").innerHTML = "A* Search is weighted and guarantees the shortest path!"
      document.getElementById("algobottom").innerHTML = "A* Algorithm"
    ...
    document.getElementById("startButtonGreedy").onclick = () => {
      document.getElementById("startbottom").innerHTML = "Ready to Visualize Greedy!"
      document.getElementById("algobottom").innerHTML = "Greedy Algorithm"
      this.currentAlgorithm = "greedy";
      this.changeStartNodeImages();
    }

    document.getElementById("startButtonBFS").onclick = () => {
      document.getElementById("startbottom").innerHTML = "Ready to Visualize Breadth-First!"
      document.getElementById("algobottom").innerHTML = "Breadth-First Algorithm"
    ...
    document.getElementById("startButtonDFS").onclick = () => {
      document.getElementById("startbottom").innerHTML = "Ready to Visualize Depth-First!"
      document.getElementById("algobottom").innerHTML = "Depth-First Algorithm"
      this.currentAlgorithm = "dfs";
      this.clearWeights();
      this.changeStartNodeImages();
    }

    document.getElementById("genRand").onclick = () => {
      this.clearWalls();
      this.clearPath("clickedButton");
      this.createMazeOne("wall");
    }

    document.getElementById("genRecurs").onclick = () => {
      this.clearWalls();
      this.clearPath("clickedButton");
      this.toggleButtons();
    ...
    document.getElementById("clearBoard").onclick = () => {
      let navbarHeight = document.getElementById("getContentHeight").clientHeight;
    ...
    document.getElementById("secondTarget").onclick = () => {
      let innerHTML = document.getElementById("secondTarget").innerHTML;
      if (this.currentAlgorithm !== "bidirectional") {
        if (innerHTML.includes("Add")) {
          ...
          if (this.target === objectNodeId || this.start === objectNodeId || this.numberOfObjects === 1) {
            console.log("Unable to Insert Target");
          } else 
          {
            document.getElementById("targetbottom").innerHTML = 'Remove Target';
            this.clearPath("clickedButton");
          ...
          document.getElementById("targetbottom").innerHTML = "Add Medial Target";
...
let navbarHeight = $("#getContentHeight").height();
...
function stairDemonstration(board) {
  ...
  while (currentIdX < board.height - 23 && currentIdY < board.width) {
    let currentId = `${currentIdX}-${currentIdY}`;
    let currentNode = board.nodes[currentId];
    let currentHTMLNode = document.getElementById(currentId);
    if (!relevantStatuses.includes(currentNode.status)) {
  ...
  while (currentIdX > -10 && currentIdY < board.width - 1) {
    let currentId = `${currentIdX}-${currentIdY}`;
    let currentNode = board.nodes[currentId];
    let currentHTMLNode = document.getElementById(currentId);
    if (!relevantStatuses.includes(currentNode.status)) {
